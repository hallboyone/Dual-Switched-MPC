...
\NewDocumentCommand{\idxset}{m}{\ensuremath{\int_{#1}}}
...
% ============== Autoref Titles ================
\renewcommand{\equationcrefname}{Equation}
\renewcommand{\sectioncrefname}{Section}
\newcommand{\remarkcrefname}{Remark}
\newcommand{\algorithmcrefname}{Algorithm}
...
\NewDocumentCommand{\gnumlabels}{}{\ensuremath{L}}