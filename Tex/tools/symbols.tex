...
\newcommand{\agent}[1]{\ensuremath{\agents_{(#1)}}}
...
\NewDocumentCommand{\gnumnodes}{}{\ensuremath{C_n^{\graph}}}
\NewDocumentCommand{\gnodeedges}{m}{\ensuremath{\mathcal{E}_{#1}}}
\NewDocumentCommand{\gnodelabel}{m}{\ensuremath{\mathcal{L}_{#1}}}
\NewDocumentCommand{\gnumlabels}{}{\ensuremath{C_l^{\graph}}}