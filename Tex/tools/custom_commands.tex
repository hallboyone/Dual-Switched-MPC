...
\renewcommand{\theoremcrefname}{Theorem}
\renewcommand{\algorithmcrefname}{Algorithm}
\newcommand{\definitioncrefname}{Def.}
\newcommand{\lemmacrefname}{Lemma}
\newcommand{\assumptioncrefname}{Assumption}
